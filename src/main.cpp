...
std::vector<std::vector<std::vector<float>>> trueColors(400, std::vector<std::vector<float>>(300, std::vector<float>(4, 0)));

int main() {
    Screen screen(400, 300, 90, 90 * 400 / 300);
    screen.setOrigin(sf::Vector3f(0, 0, 0));
    // SphereObject sphere(1, 3, 5, -2, sf::Color::Green, 0.0, 1.0);
    SphereObject sphere2(1, 0, 4.5, -.5, sf::Color::Blue, 1.0, 1.0);
    // SphereObject sphere3(1, -3, 5.5, -.5, sf::Color::Red, 0.0, 0.0);
